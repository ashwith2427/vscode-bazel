...
FREETYPE_PUBLIC_DEFINES = [
...
] + select(
    {
        ...
        "//conditions:default": [
            "FT_CONFIG_MODULES_H=<third_party/freetype/config/ftmodule.h>",
            "FT_CONFIG_OPTIONS_H=<third_party/freetype/config/ftoption.h>",
        ],
    },
)
FREETYPE_LOCAL_DEFINES = ["FT2_BUILD_LIBRARY","FT_CONFIG_OPTION_USE_ZLIB"]
...
cc_library(
    ...
    hdrs = [
        ...
        "third_party/freetype/config/ftmodule.h",
        "third_party/freetype/config/ftoption.h",
        "third_party/freetype/config/ftmodule.h",
        "third_party/freetype/config/ftoption.h",
    ],
    copts = [
